...
Currently pursuing a **B.Tech in Computer Science** at **Amity University Uttar Pradesh, Lucknow Campus (2022–2026)**, I enjoy solving real-world business problems using **Python**, **SQL**, **Power BI**, **Microsoft Excel (Advanced)**, **Machine Learning**, **Data Analytics**, and **Business Intelligence**.

During my internship at **DRDO (RCMA/CEMILAC)**, I worked on technical projects that strengthened my analytical thinking, software development, and problem-solving skills while gaining hands-on experience in building practical, real-world solutions.

I'm passionate about **Artificial Intelligence**, **Machine Learning**, **Generative AI**, **Data Science**, **Business Analytics**, and **Data Visualization**. I continuously upskill through hands-on projects, competitive programming, and exploring emerging technologies.

I enjoy collaborating with teams, learning new technologies, and transforming ideas into scalable, impactful solutions.
...
I'm actively seeking **Full-Time**, **Internship**, and **Entry-Level** opportunities where I can apply my analytical and technical skills to solve real-world business problems and contribute to data-driven products.

**Open to:** **Data Analyst** • **Business Analyst** • **Data Scientist** • **AI & Machine Learning Engineer**
